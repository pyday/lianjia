# -*- coding: utf-8 -*-
import copy
from lianjia.items import ResidenceInfoItem,ResidencePriceItem,DealItem,EsfItem
import MySQLdb
import MySQLdb.cursors
from lianjia.Exception.readUtils import MysqlConfig
import datetime
...
class LjProjectPipeline(object):
    ...
    def _insert_residence_info(self, cursor, item, spider):
        ...
        try:
            # print cursor
            cursor.execute("insert into lj_xiaoqu (city,district,community,residence_name,address,\
